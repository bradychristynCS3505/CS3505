                            ...
                            const AVFrame *pict, int *got_packet)
{
    ...
    int pad_bytes_per_row, pal_entries = 0, compression = MPFF_RGB;
    ...
    // and related pages.
#define SIZE_MPFFFILEHEADER 14
#define SIZE_MPFFINFOHEADER 40
    hsize = SIZE_MPFFFILEHEADER + SIZE_MPFFINFOHEADER + (pal_entries << 2);
